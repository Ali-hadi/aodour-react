...
const SaleIcon2 = "https://storage.googleapis.com/aodour_v1/campaign_images/icons_black/icon1.png";
...
const SaleBanner = "https://storage.googleapis.com/aodour_v1/campaign/Feb/landing_banner4.png";
const SaleBannerMobile = "https://storage.googleapis.com/aodour_v1/campaign/Feb/landing_mobile4.png";
  ...
  return (
    <>
      <Helmet>
        ...
        <title>
          {"Aodour Valentine's Day Sale 2021 upto 70% OFF - Aodour"}
        </title>
        ...
        <div className="group_filter">
          <div className="container-fluid">
            ...
            <ReactOwlCarousel lazyLoad={true} responsive={responsive}>
              ...
              >
                <span className="fullimg" className={getActiveClass('40% off')}>
