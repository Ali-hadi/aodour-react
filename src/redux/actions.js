import {
  ...
  GET_11CAMPAIGN_FLASH_SALE_FAILED,
  GET_11CAMPAIGN_FLASH_SALE_SUCCESS,

  GET_CAMPAIGN_CATEGORY_PRODUCTS,
  GET_CAMPAIGN_CATEGORY_PRODUCTS_FAILED,
  GET_CAMPAIGN_CATEGORY_PRODUCTS_SUCCESS,

  GET_11CAMPAIGN_LISTING,
  GET_11CAMPAIGN_LISTING_FAILED,
  GET_11CAMPAIGN_LISTING_SUCCESS,


  GET_SET_CART,
  GET_SET_CART_FAILED,
  GET_SET_CART_SUCCESS,


  GET_11CAMPAIGN_BRAND,
  GET_11CAMPAIGN_BRAND_FAILED,
  GET_11CAMPAIGN_BRAND_SUCCESS,

  GET_LIVE_SESSION_SALE,
  GET_LIVE_SESSION_SALE_FAILED,
  GET_LIVE_SESSION_SALE_SUCCESS,

  GET_CAMPAIGN_BUY2_GET_1,
  GET_CAMPAIGN_BUY2_GET_1_FAIL,
  GET_CAMPAIGN_BUY2_GET_1_SUCCESS,

  GET_CAMPAIGN_MYSTERYBOX,
  GET_CAMPAIGN_MYSTERYBOX_FAIL,
  GET_CAMPAIGN_MYSTERYBOX_SUCCESS,
...
export const getCampaignBuy2Get1 = () => ({
  type: GET_CAMPAIGN_BUY2_GET_1,
});

export const getCampaignBuy2Get1Success = (data) => ({
  type: GET_CAMPAIGN_BUY2_GET_1_SUCCESS,
  payload: data,
});

export const getCampaignBuy2Get1Fail = (data) => ({
  type: GET_CAMPAIGN_BUY2_GET_1_FAIL,
  payload: data,
});



export const getCampaignMysteryBox = () => ({
  type: GET_CAMPAIGN_MYSTERYBOX,
});

export const getCampaignMysteryBoxSuccess = (data) => ({
  type: GET_CAMPAIGN_MYSTERYBOX_SUCCESS,
  payload: data,
});

export const getCampaignMysteryBoxFail = (data) => ({
  type: GET_CAMPAIGN_MYSTERYBOX_FAIL,
  payload: data,
});
...
export const getGarnierSuccess = (data) => ({
  type: GET_GARNIER_SUCCESS,
  payload: data,
});

export const getGarnierFail = (data) => ({
  type: GET_GARNIER_FAIL,
  payload: data,
});
...
export const Get11campaignFlashSale = () => ({
  type: GET_11CAMPAIGN_FLASH_SALE,
});

export const get11CampaignFlashSaleListingSuccess = (data) => ({
  type: GET_11CAMPAIGN_FLASH_SALE_SUCCESS,
  payload: data,
});

export const get11CampaignFlashSaleListingFail = (data) => ({
  type: GET_11CAMPAIGN_FLASH_SALE_FAILED,
  payload: data,
});



export const GetCampaignCategoryProducts = () => ({
  type: GET_CAMPAIGN_CATEGORY_PRODUCTS,
});

export const getCampaignCategoryProductsSuccess = (data) => ({
  type: GET_CAMPAIGN_CATEGORY_PRODUCTS_SUCCESS,
  payload: data,
});

export const getCampaignCategoryProductsFail = (data) => ({
  type: GET_CAMPAIGN_CATEGORY_PRODUCTS_FAILED,
  payload: data,
});



export const Get11campaignListing = () => ({
  type: GET_11CAMPAIGN_LISTING,
});

export const get11CampaignListingSuccess = (data) => ({
  type: GET_11CAMPAIGN_LISTING_SUCCESS,
  payload: data,
});

export const get11CampaignListingFail = (data) => ({
  type: GET_11CAMPAIGN_LISTING_FAILED,
  payload: data,
});


export const GetSetCart = (payload) => ({
  type: GET_SET_CART,
  payload
});

export const getSetCartSuccess = (data) => ({
  type: GET_SET_CART_SUCCESS,
  payload: data,
});

export const getSetCartFail = (data) => ({
  type: GET_SET_CART_FAILED,
  payload: data,
});


export const Get11campaignBrand = () => ({
  type: GET_11CAMPAIGN_BRAND,
});

export const get11CampaignBrandSuccess = (data) => ({
  type: GET_11CAMPAIGN_BRAND_SUCCESS,
  payload: data,
});

export const get11CampaignBrandFail = (data) => ({
  type: GET_11CAMPAIGN_BRAND_FAILED,
  payload: data,
});


export const reset11CampaignBrandSuccess = (data) => ({
  type: GET_11CAMPAIGN_BRAND_SUCCESS,
  payload: data,
});
...
export const GetLiveSessionSale = () => ({
  type: GET_LIVE_SESSION_SALE,
});

export const getLiveSessionSaleSuccess = (data) => ({
  type: GET_LIVE_SESSION_SALE_SUCCESS,
  payload: data,
});

export const getLiveSessionSaleFail = (data) => ({
  type: GET_LIVE_SESSION_SALE_FAILED,
  payload: data,
});
